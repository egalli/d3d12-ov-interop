...
int main() {
  ...
  if (FAILED(::D3D12CreateDevice(nullptr, D3D_FEATURE_LEVEL_12_1,
  ...
  if (FAILED(::D3D11On12CreateDevice(
          d3d12_device.Get(), D3D11_CREATE_DEVICE_DEBUG, nullptr, 0,
  ...
  try {
    ...
    ov::Core core;
    ov::intel_gpu::ocl::D3DContext context(core, d3d11_device.Get());
